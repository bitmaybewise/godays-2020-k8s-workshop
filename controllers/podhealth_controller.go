...
import (
	...
	trainingv1alpha1 "example.com/m/api/v1alpha1"
)
...
// +kubebuilder:rbac:groups=training.example.com,resources=podhealths,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=training.example.com,resources=podhealths/status,verbs=get;update;patch
...
func (r *PodHealthReconciler) Reconcile(req ctrl.Request) (result ctrl.Result, err error) {
	...
	if err = r.List(ctx, podList, client.InNamespace(podHealth.Namespace), client.MatchingLabelsSelector{Selector: podSelector}); err != nil {
	...
	podHealth.Status.NotReady = notReady
